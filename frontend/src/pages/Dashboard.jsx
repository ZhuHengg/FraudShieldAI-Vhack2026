    ...
    <div className="max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 space-y-6 flex flex-col h-full">
          ...
          <TransactionFeed transactions={transactions} totalTotalBufferCount={total} engineOnline={engineOnline} engine={engine} />
        </div>
      ...
      <ModelDisagreementTable disagreements={modelDisagreements} />
